 ...
 * 
 * Usage:
 *   <link rel="stylesheet" href="mgfview.css">
 ...
 *   ✓ MGFUtils - Utility functions (formatting, validation, I/O)
 *   ✓ ViewerState - Centralized state management with events
 *   ✓ UIBuilder - Programmatic UI construction
 *   ✓ ComponentUpdaters - Efficient DOM update functions
 *   ✓ MGFParser - Complete MGF format parser
 *   ✓ Spectrum - Spectrum data class with helper methods
 *   ✓ SpectrumPlot - Interactive Canvas-based plotting
 *   ✓ SearchFilter - Advanced search and filtering
 *   ✓ StatisticsPanel - Statistical analysis and charts
 *   ✓ ExportManager - Multi-format data export
 *   ✓ Plugin/PluginSystem - Extensible plugin architecture
 *   ✓ MGFViewer - Main high-level viewer class
 *   ✓ MGFView - Public API namespace
 * 
 * ===============================================================
 */
...
(function(window) {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 1: UTILITY FUNCTIONS (MGFUtils)
  // ═══════════════════════════════════════════════════════════
...
const MGFUtils = {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 2: STATE MANAGEMENT (ViewerState)
  // ═══════════════════════════════════════════════════════════
...
class ViewerState {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 3: UI BUILDER (UIBuilder)
  // ═══════════════════════════════════════════════════════════
...
class UIBuilder {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 4: COMPONENT UPDATERS (ComponentUpdaters)
  // ═══════════════════════════════════════════════════════════
...
const ComponentUpdaters = {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 5: MGF PARSER (MGFParser)
  // ═══════════════════════════════════════════════════════════
...
class MGFParser {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 6: SPECTRUM CLASS (Spectrum)
  // ═══════════════════════════════════════════════════════════
...
class Spectrum {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 7: PLOT VISUALIZATION (SpectrumPlot)
  // ═══════════════════════════════════════════════════════════
...
class SpectrumPlot {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 8: SEARCH & FILTER (SearchFilter)
  // ═══════════════════════════════════════════════════════════
...
class SearchFilter {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 9: STATISTICS (StatisticsPanel)
  // ═══════════════════════════════════════════════════════════
...
class StatisticsPanel {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 10: EXPORT MANAGER (ExportManager)
  // ═══════════════════════════════════════════════════════════
...
class ComparisonPlugin extends Plugin {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 12: MGF VIEWER (MGFViewer - Main Class)
  // ═══════════════════════════════════════════════════════════
...
class MGFViewer {
  ...
  // ═══════════════════════════════════════════════════════════
  // SECTION 13: PUBLIC API & INITIALIZATION (MGFView)
  // ═══════════════════════════════════════════════════════════
...
if (typeof console !== 'undefined' && console.log) {
  ...
  // Export all classes and utilities to window object
